...
export default defineConfig(({ mode }) => ({
  ...
  define: {
    ...
    'import.meta.env.VITE_SUPABASE_PUBLISHABLE_KEY': JSON.stringify(process.env.VITE_SUPABASE_PUBLISHABLE_KEY ?? 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InhjYWZyc3BoaG5sc3N1enVhdHVvIiwicm9sZSI6ImFub24iLCJpYXQiOjE3MzE2NjM1OTcsImV4cCI6MjA0NzIzOTU5N30.LWMZ10rOgRGKZDcvW4i3f5t-_bz5UhOxEq1wXfNsgAg'),
