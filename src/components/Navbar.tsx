...
export const Navbar = () => {
  ...
  return <nav className={`${isHome ? "fixed top-0 left-0 w-full bg-transparent backdrop-blur-sm" : "sticky top-0 bg-background/98 backdrop-blur-md border-b border-border shadow-sm"} z-50 transition-all duration-300`}>
