-- ========================================
-- SLEEK APPARELS SAMPLE DATA SEED - READY TO RUN
-- ========================================
-- This file has been customized with YOUR actual user UUIDs
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('00000000-0000-0000-0000-000000000002'::uuid, 'Michael Chen', 'michael.chen@test.sleekapp.com', 'Green Valley High School', '+1-555-0102', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('00000000-0000-0000-0000-000000000003'::uuid, 'Emily Rodriguez', 'emily.rodriguez@test.sleekapp.com', 'TechCorp Inc', '+1-555-0103', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('00000000-0000-0000-0000-000000000004'::uuid, 'James Williams', 'james.williams@test.sleekapp.com', 'City United FC', '+1-555-0104', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('00000000-0000-0000-0000-000000000005'::uuid, 'Lisa Anderson', 'lisa.anderson@test.sleekapp.com', 'Wholesale Apparel Distributors', '+1-555-0105', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('00000000-0000-0000-0000-000000000102'::uuid, 'Fatima Rahman', 'fatima.rahman@test.sleekapp.com', 'Active Sports Textiles', '+880-1711-000102', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('00000000-0000-0000-0000-000000000103'::uuid, 'Karim Textile', 'karim.textile@test.sleekapp.com', 'Bengal Uniforms Manufacturing', '+880-1711-000103', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('00000000-0000-0000-0000-000000000104'::uuid, 'Nazma Begum', 'nazma.begum@test.sleekapp.com', 'Premium Fabric Mills', '+880-1711-000104', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('00000000-0000-0000-0000-000000000105'::uuid, 'Rashid Ahmed', 'rashid.ahmed@test.sleekapp.com', 'Dhaka Trims & Accessories', '+880-1711-000105', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, updated_at)
VALUES 
  ('441f2e49-44fb-48c6-9dc4-cbf1929677e1'::uuid, 'Admin User', 'admin@test.sleekapp.com', 'Sleek Apparels', '+880-1711-999999', NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name;
...
-- Certifications for Dhaka Knitwear Ltd (Ahmed)
...
VALUES 
  ('7d52fff8-1992-4994-9817-296e7da7e27b'::uuid, 'WRAP Certification', 'Worldwide Responsible Accredited Production', '2023-01-15', '2026-01-14', 'https://example.com/cert-wrap.pdf'),
  ('7d52fff8-1992-4994-9817-296e7da7e27b'::uuid, 'OEKO-TEX Standard 100', 'OEKO-TEX Association', '2023-06-20', '2024-06-19', 'https://example.com/cert-oeko.pdf'),
  ('7d52fff8-1992-4994-9817-296e7da7e27b'::uuid, 'ISO 9001:2015', 'International Organization for Standardization', '2022-03-10', '2025-03-09', 'https://example.com/cert-iso.pdf')
...
-- Sample Blog Posts (Author = Admin)
...
VALUES
  -- Order 1: Sarah (Fashion Brand) ordering T-Shirts from Ahmed
  (
    '50000000-0000-0000-0000-000000000001'::uuid,
    '76aca2d5-4649-4a98-bca2-2274c2527a3a'::uuid, -- Sarah Johnson
    '7d52fff8-1992-4994-9817-296e7da7e27b'::uuid, -- Ahmed Hassan (Dhaka Knitwear)
  ...
  -- Order 4: Corporate ordering Polos from Ahmed
  (
  ...
  -- Order 5: Wholesaler bulk order from Ahmed
  (
...
VALUES
  ('page_view', '/looptrace-technology', '{"source": "organic", "device": "desktop"}'::jsonb),
  ('page_view', '/marketplace', '{"source": "direct", "device": "mobile"}'::jsonb),
  ('cta_click', '/looptrace-technology', '{"button_id": "get_instant_quote", "position": "hero"}'::jsonb),
  ('page_view', '/portfolio', '{"source": "google", "device": "desktop"}'::jsonb),
  ('cta_click', '/become-supplier', '{"button_id": "join_as_supplier", "position": "top"}'::jsonb)
...
BEGIN
  ...
  RAISE NOTICE '==============================================';
  RAISE NOTICE 'Created with YOUR actual UUIDs:';
  RAISE NOTICE '- Sarah Johnson (Buyer): 76aca2d5-4649-4a98-bca2-2274c2527a3a';
  RAISE NOTICE '- Ahmed Hassan (Supplier): 7d52fff8-1992-4994-9817-296e7da7e27b';
  RAISE NOTICE '- Admin User: 441f2e49-44fb-48c6-9dc4-cbf1929677e1';
  RAISE NOTICE '';
  ...
  RAISE NOTICE '- sarah.johnson@test.sleekapp.com / TestBuyer123!';
  RAISE NOTICE '- ahmed.hassan@test.sleekapp.com / TestSupplier123!';
  RAISE NOTICE '- admin@test.sleekapp.com / TestAdmin123!';
  RAISE NOTICE '==============================================';
END $$;
