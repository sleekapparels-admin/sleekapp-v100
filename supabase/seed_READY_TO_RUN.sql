...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, avatar_url, updated_at)
VALUES 
  ('7d52fff8-1992-4994-9817-296e7da7e27b'::uuid, 'Ahmed Hassan', 'ahmed.hassan@test.sleekapp.com', 'Dhaka Knitwear Ltd', '+880-1711-000101', NULL, NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name,
...
INSERT INTO public.profiles (id, full_name, email, company_name, phone, avatar_url, updated_at)
VALUES 
  ('441f2e49-44fb-48c6-9dc4-cbf1929677e1'::uuid, 'Admin User', 'admin@test.sleekapp.com', 'Sleek Apparels', '+880-1711-999999', NULL, NOW())
ON CONFLICT (id) DO UPDATE SET
  full_name = EXCLUDED.full_name,
  email = EXCLUDED.email,
  company_name = EXCLUDED.company_name;
